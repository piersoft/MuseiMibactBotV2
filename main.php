 ...
 function shell($inline_query,$telegram,$text,$chat_id,$user_id,$location,$reply_to_msg)
{
    ...
    $telegram->sendMessage($content);
		...
		//	sleep (1);
			...
			$html=file_get_contents('https://dati.beniculturali.it/sparql?default-graph-uri=&query=select+*+%7B%0D%0A++select+distinct+%3Fs+as+%3Fsubject%0D%0A++%3Fname%0D%0A++%3Fdescription+%3FIdentifier%0D%0A++%3Flat+%3Flon%0D%0A++%3FIndirizzo%0D%0A++%3FCodice_postale+%3FComune%0D%0A+%3FImage++%0D%0A+++%7B%0D%0A+++graph+%3Chttp%3A%2F%2Fdati.beniculturali.it%2Fmibact%2Fluoghi%3E+%7B%0D%0A++++%3Fs+rdf%3Atype+cis%3ACulturalInstituteOrSite+%3B%0D%0A+++++++cis%3AinstitutionalCISName+%3Fname+FILTER+%28lang%28%3Fname%29+%3D+%27it%27%29.%0D%0A++++%3Fs+l0%3Adescription++%3Fdescription+FILTER+%28lang%28%3Fdescription%29+%3D+%27it%27%29.%0D%0A++++%3Fs+l0%3Aidentifier+%3FIdentifier.%0D%0A++++optional+%7B%3Fs+geo%3Alat+%3Flat%7D.%0D%0A++++optional+%7B%3Fs+geo%3Along+%3Flon%7D.%0D%0A++++optional+%7B%3Fs+foaf%3Adepiction+%3FImage%7D.%0D%0A++++%0D%0A+++++%3Fs+cis%3AhasSite+%5Bcis%3AsiteAddress+%3Faddress+%5D+.%0D%0A+++++%3Faddress+clvapit%3AfullAddress+%3FIndirizzo.%0D%0A+++++%3Faddress+clvapit%3ApostCode+%3FCodice_postale.%0D%0A+++++%3Faddress+clvapit%3AhasCity+%5Brdfs%3Alabel+%3FComune%5D++filter%28regex%28%3FComune%2C%22'.$text.'%22%29%29.%0D%0A%0D%0A+++++%0D%0A+++%7D%0D%0A++%7D%0D%0A++ORDER+BY+%3Fs%0D%0A+%7D%0D%0A+limit+100%0D%0A+offset+0&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on');
...
//	$text=extractString($text,"🏛 ","-");
	...
	$html=file_get_contents('https://dati.beniculturali.it/sparql?default-graph-uri=&query=select+*+%7B%0D%0A++select+distinct+%3Fs+as+%3Fsubject%0D%0A++%3Fname%0D%0A++%3Fdescription+%3FIdentifier%0D%0A++%3Flat+%3Flon%0D%0A++%3FIndirizzo%0D%0A++%3FCodice_postale+%3FComune+%3FProvincia%0D%0A++%3FPrenotazioni+%0D%0A++%3FTelefono+%3FFax+%3FEmail+%3FWebSite+%3FImage++%0D%0A+++%7B%0D%0A+++graph+%3Chttp%3A%2F%2Fdati.beniculturali.it%2Fmibact%2Fluoghi%3E+%7B%0D%0A++++%3Fs+rdf%3Atype+cis%3ACulturalInstituteOrSite+%3B%0D%0A+++++++cis%3AinstitutionalCISName+%3Fname+FILTER+%28lang%28%3Fname%29+%3D+%27it%27%29.%0D%0A++++optional+%7B+%3Fs+l0%3Adescription++%3Fdescription+%7D+FILTER+%28lang%28%3Fdescription%29+%3D+%27it%27%29%0D%0A++++%3Fs+l0%3Aidentifier+%3FIdentifier++filter%28regex%28%3FIdentifier%2C%22'.$text.'%22%29%29%0D%0A++++optional+%7B+%3Fs+geo%3Alat+%3Flat%7D.%0D%0A++++optional+%7B+%3Fs+geo%3Along+%3Flon%7D.%0D%0A++++optional+%7B+%3Fs+foaf%3Adepiction+%3FImage%7D.%0D%0A++++%0D%0A+++++%3Fs+cis%3AhasSite+%5Bcis%3AsiteAddress+%3Faddress+%5D+.%0D%0A+++++%3Faddress+clvapit%3AfullAddress+%3FIndirizzo.%0D%0A+++++%3Faddress+clvapit%3ApostCode+%3FCodice_postale.%0D%0A+++++%3Faddress+clvapit%3AhasCity+%5Brdfs%3Alabel+%3FComune%5D.%0D%0A+++++%3Faddress+clvapit%3AhasProvince+%5Brdfs%3Alabel+%3FProvincia%5D.%0D%0A++++%0D%0A++++optional+%7B%3Fs+accessCondition%3AhasAccessCondition+%5Brdf%3Atype+accessCondition%3ABooking+%3B%0D%0A+++++++++++++++++++++++++++++++++++++++++++++++++++++rdfs%3Alabel+%3FPrenotazioni%5D+%7D%0D%0A++++optional+%7B%0D%0A+++++%3Fs+smapit%3AhasOnlineContactPoint+%3FcontactPoint+.%0D%0A+++++optional+%7B+%3FcontactPoint+smapit%3AhasTelephone+%5Bsmapit%3AhasTelephoneType+%3Chttps%3A%2F%2Fw3id.org%2Fitalia%2Fcontrolled-vocabulary%2Fclassifications-for-public-services%2Fchannel%2F031%3E+%3B%0D%0A+++++++++++++++++++++++++++++++++++++++++++++++++++smapit%3AtelephoneNumber+%3FTelefono%5D+%7D%0D%0A+++++optional+%7B+%3FcontactPoint+smapit%3AhasTelephone+%5Bsmapit%3AhasTelephoneType+%3Chttps%3A%2F%2Fw3id.org%2Fitalia%2Fcontrolled-vocabulary%2Fclassifications-for-public-services%2Fchannel%2F033%3E+%3B%0D%0A+++++++++++++++++++++++++++++++++++++++++++++++++++smapit%3AtelephoneNumber+%3FFax%5D+%7D%0D%0A+++++optional+%7B+%3FcontactPoint+smapit%3AhasEmail+%5Bsmapit%3AemailAddress+%3FEmail%5D+%7D%0D%0A+++++optional+%7B+%3FcontactPoint+smapit%3AhasWebSite+%5Bsmapit%3AURL+%3FWebSite%5D+%7D++++%0D%0A++++%7D+++%0D%0A++++optional+%7B%0D%0A+++++%3Fs+potapit%3AhasTicket+%3Fticket+.%0D%0A+++++%3Foffer+potapit%3Aincludes+%3Fticket+%3B%0D%0A++++++++++++potapit%3AhasPriceSpecification+%5Bpotapit%3AhasCurrencyValue+%3FBiglietti%5D%0D%0A++++%7D%0D%0A+++%7D%0D%0A++%7D%0D%0A++ORDER+BY+%3Fs%0D%0A+%7D%0D%0A+limit+100%0D%0A+offset+0&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on');
...
$html=file_get_contents('https://dati.beniculturali.it/sparql?default-graph-uri=&query=select+*+%7B%0D%0A++select+distinct+%3Fs+as+%3Fsubject%0D%0A++%3Fname%0D%0A++%3Fdescription+%3FIdentifier%0D%0A++%3Flat+%3Flon%0D%0A++%3FIndirizzo%0D%0A++%3FCodice_postale+%3FComune%0D%0A+%3FImage++%0D%0A+++%7B%0D%0A+++graph+%3Chttp%3A%2F%2Fdati.beniculturali.it%2Fmibact%2Fluoghi%3E+%7B%0D%0A++++%3Fs+rdf%3Atype+cis%3ACulturalInstituteOrSite+%3B%0D%0A+++++++cis%3AinstitutionalCISName+%3Fname+FILTER+%28lang%28%3Fname%29+%3D+%27it%27%29.%0D%0A++++%3Fs+l0%3Adescription++%3Fdescription+FILTER+%28lang%28%3Fdescription%29+%3D+%27it%27%29.%0D%0A++++%3Fs+l0%3Aidentifier+%3FIdentifier.%0D%0A++++optional+%7B%3Fs+geo%3Alat+%3Flat%7D.%0D%0A++++optional+%7B%3Fs+geo%3Along+%3Flon%7D.%0D%0A++++optional+%7B%3Fs+foaf%3Adepiction+%3FImage%7D.%0D%0A++++%0D%0A+++++%3Fs+cis%3AhasSite+%5Bcis%3AsiteAddress+%3Faddress+%5D+.%0D%0A+++++%3Faddress+clvapit%3AfullAddress+%3FIndirizzo.%0D%0A+++++%3Faddress+clvapit%3ApostCode+%3FCodice_postale.%0D%0A+++++%3Faddress+clvapit%3AhasCity+%5Brdfs%3Alabel+%3FComune%5D++filter%28regex%28%3FComune%2C%22'.$comune.'%22%29%29.%0D%0A%0D%0A+++++%0D%0A+++%7D%0D%0A++%7D%0D%0A++ORDER+BY+%3Fs%0D%0A+%7D%0D%0A+limit+100%0D%0A+offset+0&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on');
